...
export function MagicBlobs(framework) {
		...
		function generateMaterials() {
					...
					const path = "./../../../../../../assets/images/textures/cube/";
					const format = '.jpg';
					const urls = [
						require(path + 'px' + format), require(path + 'nx' + format),
						require(path + 'py' + format), require(path + 'ny' + format),
						require(path + 'pz' + format), require(path + 'nz' + format)
					];
