...
import {AdvancedDetailsList} from '../ui';
...
import {openPlaylistManager, closePlaylistManager, addToPlaylist, removeFromPlaylist, playTrack} from '../../store/music/music.actions';
...
const PlaylistManager: React.FunctionComponent<IPlaylistManagerProps> = props => {
  ...
  return (
    <>
      {props.playlistManagerIndex === -1 ?
        ...
        <AdvancedDetailsList key={`${props.playlistChangeKey} Playlist editor`} items={props.playlists[props.playlistManagerIndex]['playlistTracks']} columns={TrackListColumns}/>
