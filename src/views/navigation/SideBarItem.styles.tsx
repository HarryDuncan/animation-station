...
import { SIDE_BAR_TRANSITION_SPEED } from "./NavigationBar.styles";
...
const disabledStyles = css`
  ...
  &&,
  &&:hover {
    color: ${({ theme }) => theme.colors.mono.text02.darken(0.25).toString()};
  }

  path {
    fill: ${({ theme }) => theme.colors.mono.text02.darken(0.25).toString()};
  }
`;
