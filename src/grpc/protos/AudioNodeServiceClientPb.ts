...
export class AudioNodeServiceClient {
  ...
  methodInfoInitializeAudioNode = new grpcWeb.AbstractClientBase.MethodInfo(
    protos_audioNode_pb.InitializeAudioNodeResponse,
    (request: protos_audioNode_pb.InitializeAudioNodeRequest) => {
      return request.serializeBinary();
    },
    protos_audioNode_pb.InitializeAudioNodeResponse.deserializeBinary
  );

  initializeAudioNode(
    request: protos_audioNode_pb.InitializeAudioNodeRequest,
    metadata: grpcWeb.Metadata | null): Promise<protos_audioNode_pb.InitializeAudioNodeResponse>;

  initializeAudioNode(
    request: protos_audioNode_pb.InitializeAudioNodeRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error,
               response: protos_audioNode_pb.InitializeAudioNodeResponse) => void): grpcWeb.ClientReadableStream<protos_audioNode_pb.InitializeAudioNodeResponse>;

  initializeAudioNode(
    request: protos_audioNode_pb.InitializeAudioNodeRequest,
    metadata: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.Error,
               response: protos_audioNode_pb.InitializeAudioNodeResponse) => void) {
  ...
  methodInfoSetUpTrack = new grpcWeb.AbstractClientBase.MethodInfo(
    protos_audioNode_pb.SetUpTrackResponse,
    (request: protos_audioNode_pb.SetUpTrackRequest) => {
      return request.serializeBinary();
    },
    protos_audioNode_pb.SetUpTrackResponse.deserializeBinary
  );

  setUpTrack(
    request: protos_audioNode_pb.SetUpTrackRequest,
    metadata: grpcWeb.Metadata | null): Promise<protos_audioNode_pb.SetUpTrackResponse>;

  setUpTrack(
    request: protos_audioNode_pb.SetUpTrackRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error,
               response: protos_audioNode_pb.SetUpTrackResponse) => void): grpcWeb.ClientReadableStream<protos_audioNode_pb.SetUpTrackResponse>;

  setUpTrack(
    request: protos_audioNode_pb.SetUpTrackRequest,
    metadata: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.Error,
               response: protos_audioNode_pb.SetUpTrackResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
